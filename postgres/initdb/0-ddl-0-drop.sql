...
alter table if exists file_info drop constraint if exists FK35j0h3g2aiqlstxcefqc4jo6b;
...
alter table if exists filesystems drop constraint if exists FKhf1rlrrl3r5qoewirr7hagfb6;
